...
export function AdminVacationPage() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="font-serif text-2xl sm:text-3xl font-bold text-[#45055B]">Vacation Mode</h1>
        <p className="text-[#45055B]/60 font-sans mt-1">
      ...
      <div className="bg-white rounded-2xl border border-[#45055B]/10 shadow-sm overflow-hidden">
        <div className="border-b border-[#45055B]/10 px-6 py-4 flex items-center gap-3 bg-[#FAF6F0]">
          ...
          <h2 className="font-bold text-[#45055B]">Vacation / Pause Orders</h2>
        </div>
          ...
          <button
            ...
            className={`w-full flex items-center justify-between p-4 rounded-xl border-2 transition-all ${
              vacation.is_active
                ...
                : 'border-[#45055B]/10 bg-[#45055B]/5'
            }`}
          >
            <div className="text-left">
              <p className="font-bold text-[#45055B]">
                {vacation.is_active ? '🔴 Vacation Mode is ON' : '🟢 `Vacation Mode` is OFF'}
              </p>
              <p className="text-xs text-[#45055B]/60 mt-0.5">
                {vacation.is_active
            ...
            {vacation.is_active ? (
              ...
              <ToggleLeft className="w-8 h-8 text-[#45055B]/30 shrink-0" />
            )}
          </button>

          {/* Message */}
          <div>
            <label className="text-sm font-bold text-[#45055B] mb-2 block">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-[#FAF6F0] border border-[#45055B]/20 focus:outline-none focus:border-[#D4AF37] text-[#45055B] text-sm resize-none"
            />
            <p className="text-xs text-[#45055B]/40 mt-1">
