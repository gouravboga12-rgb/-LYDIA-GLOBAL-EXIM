    ...
    <>
      ...
      <div className="lg:hidden min-h-screen bg-[#FAEDE4] font-sans flex flex-col items-center justify-center px-5 py-5 overflow-y-auto" style={{ backgroundColor: '#FAEDE4' }}>
        ...
        <div className="flex flex-col items-center mb-3.5 text-center w-full max-w-sm">
          ...
          <p className="text-gray-500 text-[11px]">Enter your credentials to access your account.</p>
        </div>
        ...
        {/* OR Google */}
        <div className="flex items-center gap-3 w-full max-w-sm my-3.5">
          <div className="h-px bg-gray-300 flex-1"></div>
          <span className="text-gray-400 text-[10px] tracking-wider uppercase font-semibold">OR</span>
          <div className="h-px bg-gray-300 flex-1"></div>
        </div>

        <button type="button" onClick={() => loginWithGoogle()} className="w-full max-w-sm bg-white border border-gray-200 text-gray-800 font-semibold py-2.5 rounded-xl flex items-center justify-center gap-2.5 text-xs shadow-sm hover:bg-gray-50 transition-colors">
        ...
        {/* Bottom Badges */}
        <div className="flex justify-between w-full max-w-sm mt-4 pt-3 border-t border-brand-gold/15 px-3">
          <div className="flex items-center gap-1.5">
            <ShieldCheck className="w-4 h-4 text-[#B38827]" strokeWidth={1.5} />
            <span className="text-gray-700 text-[10px] font-medium">Tarnish Free</span>
          </div>

          <div className="flex items-center gap-1.5">
            <Droplet className="w-4 h-4 text-[#B38827]" strokeWidth={1.5} />
            <span className="text-gray-700 text-[10px] font-medium">Waterproof</span>
          </div>

          <div className="flex items-center gap-1.5">
            <Feather className="w-4 h-4 text-[#B38827]" strokeWidth={1.5} />
