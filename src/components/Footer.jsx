        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-2">
              {/* WhatsApp */}
              <a href="https://wa.me/919014863411" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(198,161,132,0.15)', color: '#C6A184' }}
                onMouseEnter={e => { e.currentTarget.style.background='#C6A184'; e.currentTarget.style.color='#2A0845'; }}
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(198,161,132,0.15)', color: '#C6A184' }}
                onMouseEnter={e => { e.currentTarget.style.background='#C6A184'; e.currentTarget.style.color='#2A0845'; }}
                onMouseLeave={e => { e.currentTarget.style.background='rgba(198,161,132,0.15)'; e.currentTarget.style.color='#C6A184'; }}>
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ background: 'rgba(198,161,132,0.15)', color: '#C6A184' }}
                onMouseEnter={e => { e.currentTarget.style.background='#C6A184'; e.currentTarget.style.color='#2A0845'; }}
                onMouseLeave={e => { e.currentTarget.style.background='rgba(198,161,132,0.15)'; e.currentTarget.style.color='#C6A184'; }}>
